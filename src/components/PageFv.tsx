...
const PageFv = ({
  ...
  const resolvedTitleClassName =
    titleClassName ||
    'scale-y-[1.2] text-center text-[clamp(80px,calc(30px+11.25vw),320px)] leading-[0.9] font-bold tracking-tighter text-[#F78629] max-md:origin-top max-md:text-[clamp(30px,18vw,80px)] font-roboto font-black';
      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-[#F78629]/[0.2] text-center text-white mix-blend-plus-lighter max-md:py-30">
          <div className={titleWrapperClassName}>
            ...
            <div className="absolute right-0 text-[#F78629] mix-blend-plus-lighter">
              <span
                ref={clubAppRef}
                className="inline-block text-[32px] font-medium opacity-0 md:text-[44px]"
              >
                {appLabel}
              </span>
            </div>
