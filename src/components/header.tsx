...
const Header = () => {
  ...
  return (
    <header className="header fixed top-0 right-0 left-0 z-20 flex h-16 w-full items-center justify-center bg-[#03234E]/50 pr-8 pl-10 md:h-20.5 md:justify-between">
      <Link href="/">
        <Image
