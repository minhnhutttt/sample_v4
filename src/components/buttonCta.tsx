    ...
    <div className="relative mx-auto flex w-full max-w-[558px] flex-col items-center justify-center">
      ...
      >
        <span className="relative">
          ...
          <span
            className={`absolute bottom-1 left-full flex aspect-191/74 w-[120px] animate-bounce items-center justify-center bg-cover pb-1.5 text-[11px] font-medium text-[#333] md:w-[191px] md:pb-3.5 md:text-[16px] ${white ? 'bg-[url(/assets/images/bubble-p.png)]' : 'bg-[url(/assets/images/bubble.png)]'}`}
          >
            URLを入れるだけ！
          </span>
        </span>
