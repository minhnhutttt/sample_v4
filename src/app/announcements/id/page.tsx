import type { Announcement } from '@/app/types/microcms';
  ...
  const data: Announcement[] = [
    {
      ...
      revisedAt: '2026-03-23T00:00:00.000Z',
    ...
    },
    {
      ...
      revisedAt: '2026-03-20T00:00:00.000Z',
        ...
        <div className="mx-auto w-full max-w-[1400px] py-28">
          ...
          <div className="pt-15">
            <div className="grid gap-10 md:grid-cols-3 lg:gap-20">
              {data.map((item) => (
                <AnnouncementsItem key={item.id} article={item} />
              ))}
            </div>
          </div>
        </div>
