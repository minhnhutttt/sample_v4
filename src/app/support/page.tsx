        ...
        <div className="px-5">
          <div className="mx-auto w-full max-w-[1280px]">
            <div className="my-24 md:my-[170px]">
              ...
              <div className="mt-5 space-y-6 text-[#1E1E1E] md:mt-[25px]">
                {faqData01.map((item) => (
            ...
            <div className="my-24 md:my-[170px]">
              ...
              <div className="mt-8 space-y-6 text-[#1E1E1E] md:mt-[50px]">
                {faqData02.map((item) => (
                  <Faq question={item.question} key={item.question}>
                    {item.answer}
                  </Faq>
            ...
            <div className="my-24 md:my-[170px]">
              ...
              <div className="mt-8 text-[#1E1E1E] md:mt-[50px]">
                <div className="space-y-6 rounded-lg border border-[#F5F5F5] bg-[#E6E6E6] p-6 text-[14px] font-bold md:text-[16px]">
                  <div className="space-y-2">
                    <p>お名前</p>
                    <input
                      type="text"
                      placeholder="キーヴォ太郎"
                      className="w-full rounded-lg border border-[#D9D9D9] bg-white px-4 py-3"
                    />
                  </div>
                  <div className="space-y-2">
                    <p>Email</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      name=""
                      id=""
                      placeholder="どんな小さなことでも構いません。困っていることや、気になっていることを書いてください。"
                      className="h-[150px] w-full rounded-lg border border-[#D9D9D9] bg-white px-4 py-3 md:h-[200px]"
                    ></textarea>
                  </div>
                  <p className="text-[14px] md:text-[16px]">
                    通常2営業日以内にご返信します。
                    <br />
                    個人情報はサポート目的以外に使用しません。
                  </p>
                  <div className="py-[18px]">
                    <button className="flex h-[65px] w-full items-center justify-center rounded-lg bg-[#2C2C2C] text-[16px] font-bold text-white">
                      送信する
                    </button>
                  </div>
                </div>
