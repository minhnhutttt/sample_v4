  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-5 md:grid-cols-4">
        <button
          onClick={() => setTab(0)}
          className={`flex min-h-[88px] cursor-pointer items-center justify-center rounded-md border border-[#242424] text-[18px] font-bold text-[#242424] [&.active]:bg-[#242424] [&.active]:text-white ${tab === 0 && 'active'}`}
        >
          こんな人に
          <br />
          向いています
        ...
        <button
          onClick={() => setTab(1)}
          className={`flex min-h-[88px] cursor-pointer items-center justify-center rounded-md border border-[#242424] text-[18px] font-bold text-[#242424] [&.active]:bg-[#242424] [&.active]:text-white ${tab === 1 && 'active'}`}
        >
          チャンネルについて
        </button>
        <button
          onClick={() => setTab(2)}
          className={`flex min-h-[88px] cursor-pointer items-center justify-center rounded-md border border-[#242424] text-[18px] font-bold text-[#242424] [&.active]:bg-[#242424] [&.active]:text-white ${tab === 2 && 'active'}`}
        >
          支払いについて
        </button>
        <button
          onClick={() => setTab(3)}
          className={`flex min-h-[88px] cursor-pointer items-center justify-center rounded-md border border-[#242424] text-[18px] font-bold text-[#242424] [&.active]:bg-[#242424] [&.active]:text-white ${tab === 3 && 'active'}`}
        >
          アカウントについて
        </button>
      </div>
      <div className="my-8 h-px w-full bg-[#242424]"></div>
      <div className="">
        {tab === 0 && (
          <div className="">
