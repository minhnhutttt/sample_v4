  ...
  return (
    <div className="relative z-10 overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-5 text-center text-[clamp(10px,20px+100vw*.1025,120px)] leading-none font-black whitespace-nowrap text-black uppercase md:text-[clamp(30px,28px+100vw*.1525,120px)]">
          <div
            ref={wrapTextRef}
            className="relative scale-x-0 rounded-4xl bg-[#F78629] tracking-[-0.03em] text-black"
          >
            <p
              ref={text01Ref}
            ...
            <p
              ref={text04Ref}
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[20px] font-normal whitespace-nowrap text-[#242424] text-white md:text-[36px]"
            >
              <span className="font-rock-salt inline-block -rotate-14 tracking-[0.08em] text-shadow-lg">
                Let&apos;s try KIVO!!
              </span>
            </p>
          </div>
