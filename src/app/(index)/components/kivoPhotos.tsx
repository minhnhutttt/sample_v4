  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-[clamp(80px,calc(50px+17.25vw),300px)] leading-none font-bold whitespace-nowrap text-[#F78629] will-change-transform">
        ...
        <p
          ref={textRef}
          className="font-rock-salt absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[clamp(10px,4px+100vw*.05,60px)] whitespace-nowrap text-[#242424] max-md:leading-none md:text-[clamp(12px,12px+50vw*.1,40px)]"
        >
          <span className="inline-block -rotate-5 text-shadow-2xs text-shadow-lg text-shadow-white">
            PROTECT. SELL & EARN.
          </span>
        </p>
        <div
