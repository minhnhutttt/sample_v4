...
const SERVICES = [
  {
    ...
    text: '利益を設計する',
    description:
      '私たちは厳選された高品質なプロダクトの提供を通じて、お客様の事業収益を最大化するパートナーです。単なるツールの導入に留まらず、各企業の収益構造を理解し、無駄を排して利益を確実に残すための最適なソリューションを提案します。 戦略的な視点を持ちながらも、目的はあくまで事業の持続可能性。プロダクトが貴社のオペレーションに深く浸透し、導入した瞬間から実利的なインパクトを生み出すことを約束します。質の高いラインナップは、貴社のビジョンを具現化し、次なる成長ステージへと導く強力な利益のエンジンとなります。',
    riv: '/assets/lottie/1.lottie',
  },
  {
      ...
      <div className="relative mt-[4rem] md:mt-[9rem]">
        {SERVICES.map((service, i) => (
          <div
            ...
            className="h-screen w-full overflow-hidden bg-[#F2F8FF]"
          >
            <div className="relative origin-top md:pt-[10rem]">
              <div className="site-max flex flex-col">
                <div className="relative flex">
                  <div className="acc-services-item__title relative my-[2rem] flex items-center text-[2rem] font-bold text-[#16A683] md:text-[3.2rem]">
                    {service.title}
                  </div>
                </div>
