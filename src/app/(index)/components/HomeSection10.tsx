...
export default function HomeSection10() {
  ...
  useEffect(() => {
    ...
    if (!sentinel || !fixedBtn) return;

    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          fixedBtn.classList.add('fixed-sign-up-button--above-footer');
        } else {
          fixedBtn.classList.remove('fixed-sign-up-button--above-footer');
        }
      },
      { threshold: 0 },
    );
  ...
  return (
    ...
    >
      <div className="section">
        <StickySection>
          <div className="sticky--sticky sticky--full-height pt-promo-header sticky px-1">
              ...
              <div className="section-10__content row row--gx row--stretch">
                ...
                <div className="section-10__content-side col col--6:md col-divider__right:md mt-0:md col-12 mt-6.5">
                  ...
                  <div className="section-10__btn-grid">
                    <SignUpButton className="max-[568px]:mt-7" />
                  </div>
                </div>
              </div>

              <hr className="my-1" />
              {/* Sentinel: đặt ngay trước footer để detect */}
              <div ref={sentinelRef} />
      ...
      <div
        ref={fixedBtnRef}
        className="fixed-sign-up-button fixed-sign-up-button--transition-header"
      >
        <a
