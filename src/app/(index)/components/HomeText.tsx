        ...
        <div className="pt-promo-header px-1">
          <div className="title">
            <div className="title-children-wrapper">
              <svg
                ref={svgRef}
                className="intro__title svg-fix max-md:hidden"
                width="1420"
                height="500"
