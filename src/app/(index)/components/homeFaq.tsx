...
const FAQS = [
  ...
  },
  {
    ...
    a: 'はい。くらしポートでは、会社名だけでなく、貴社の得意な工事を「サービス単位」で細かく複数登録できます。そのサービス内容と、お客様の希望をAIがピンポイントで照合するため、ミスマッチのない質の高い問い合わせだけが届きます。万が一、月の問い合わせが0件だった場合は、月額料金を全額返金いたします。',
  },
  {
  ...
  },
  {
    ...
    a: '最低利用期間などの縛りはございません。退会をご希望の場合は、所定の手続きでいつでも解約が可能です。（※ここはクライアントの運用要件に合わせて後日調整）',
  },
  {
    q: 'どんな業者でも登録できますか？',
