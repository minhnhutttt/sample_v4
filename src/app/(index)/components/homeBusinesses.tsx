...
export default function HomeBusinesses() {
  return (
    <section className="w-full bg-[#F2F8FF] bg-[url(/assets/images/businesses-bg-02.png)] bg-cover bg-bottom py-20">
      <div className="px-5">
        <div className="mx-auto w-full max-w-[1100px]">
          <h2 className="text-center text-[26px] leading-snug font-black tracking-tight whitespace-nowrap text-[#0067D3] md:text-[48px]">
          ...
          <div className="mt-12 grid max-md:mx-auto max-md:max-w-[360px] max-md:gap-y-10 md:mt-[60px] md:grid-cols-3 md:gap-x-5 lg:gap-x-10">
            {BUSINESSES.map((item, i) => (
              <div
                className="overflow-hidden rounded-t-[48px] rounded-b-[6px] bg-white px-5 py-10 shadow-xl lg:px-10 lg:py-[60px]"
                key={i}
              >
      ...
      <div className="px-5 pt-22">
        <h5 className="text-center text-[22px] font-bold text-[#0067D3] md:text-[32px]">
          くらしポートが貴社にもたらす価値
        </h5>
        <div className="mx-auto mt-12 grid max-w-[360px] max-md:gap-y-10 md:mt-[60px] md:max-w-[1100px] md:grid-cols-3 md:gap-x-5 lg:gap-x-10">
          {VALUES.map((item, i) => (
            <div
              className="relative flex flex-col items-center overflow-hidden rounded-t-[48px] rounded-b-[6px] bg-white px-5 py-10 shadow-xl lg:px-10 lg:py-[60px]"
              key={i}
            >
