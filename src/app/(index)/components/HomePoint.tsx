const HomePoint = () => {
  return (
    <div className="bg-[url(/assets/images/bg-01.png)] bg-cover pt-25 pb-20 md:pt-40 md:pb-32">
      <div className="mx-auto w-full max-w-[1280px]">
        ...
        <div className="mx-auto mt-13 flex w-full max-w-[900px] flex-col items-center justify-center md:items-end md:justify-end">
        ...
        <div className="mt-16">
          ...
          <div className="relative mt-10 max-md:mb-10 md:mt-20">
            <div className="relative mx-auto flex max-w-[440px] gap-5 px-5 max-md:flex-col-reverse md:max-w-[1040px] md:flex-row-reverse md:items-start md:gap-16 md:pb-18">
