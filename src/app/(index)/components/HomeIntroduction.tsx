...
const HomeIntroduction = () => {
  ...
  return (
    <div ref={ref} className="mt-4 mb-10 md:my-[170px]">
      <div className="mx-auto w-full max-w-[1015px] bg-black/80 px-5 py-12 md:py-25">
        <h2 className="fade-up flex items-center justify-center">
          <Image
        ...
        <p className="fade-up mx-auto mt-[30px] w-full max-w-[872px] text-center text-[18px] font-medium text-[#888] md:mt-[50px] md:text-[30px]">
