...
const Hero = () => (
  <section
    id="top"
    className="relative min-h-[640px] overflow-hidden bg-white pt-[55px] pb-[40px] pl-[16px]"
  >
    ...
    <Image
      ...
      width={116}
      height={36}
      className="absolute top-[13px] left-[16px] h-[36px] w-[116px] object-contain"
    />

    <div className="relative flex w-[365px] flex-col gap-[12px]">
