const HomeStart = () => {
  return (
    <div className="px-5 py-36 md:py-50">
      <div className="relative mx-auto w-full max-w-[1120px] pb-35 min-[1110px]:pb-22">
        <div className="mb-2.5 flex flex-col items-center justify-center">
          <p className="font-inter flex aspect-248/74 w-[248px] animate-bounce justify-center bg-[url(/assets/images/bubble-04.png)] bg-cover pt-3 text-[18px] font-bold md:text-[24px]">
            URLを入れるだけ！
          </p>
