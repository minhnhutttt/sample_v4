...
const StickyOfferButton = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="h-[32px] w-[65px] shrink-0 rounded-full bg-[#ffc2cb] text-[16px] leading-[1.67] font-bold whitespace-nowrap text-[#801201] md:h-auto md:w-auto md:px-6 md:py-1 md:text-[24px]">
          無料
        </span>
