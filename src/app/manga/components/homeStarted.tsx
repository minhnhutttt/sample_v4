        ...
        <div className="loopSlide">
          <ul>
            <li className="overflow-hidden rounded-[20px] max-md:w-[160px]">
              <img src="/assets/images/manga/slider-01.png" alt="" />
            </li>
            <li className="overflow-hidden rounded-[20px] max-md:w-[160px]">
              <img src="/assets/images/manga/slider-02.png" alt="" />
            </li>
            <li className="overflow-hidden rounded-[20px] max-md:w-[160px]">
              <img src="/assets/images/manga/slider-03.png" alt="" />
            </li>
            <li className="overflow-hidden rounded-[20px] max-md:w-[160px]">
              <img src="/assets/images/manga/slider-04.png" alt="" />
            </li>
            <li className="overflow-hidden rounded-[20px] max-md:w-[160px]">
              <img src="/assets/images/manga/slider-05.png" alt="" />
            </li>
          </ul>
          <ul>
            <li className="overflow-hidden rounded-[20px] max-md:w-[160px]">
      ...
      <div className="mt-12 flex items-center justify-center md:mt-20">
        ...
        >
          ...
          <img
            ...
            src="/assets/images/manga/arrow-alt-or.svg"
            alt=""
          />
        </button>
      </div>
