  ...
  return (
    <div className="h-screen">
      <div className="slide h-full">
        <div className="slide-image bg-[url(/assets/images/manga/kv-slider-01.png)]"></div>
        <div className="slide-image bg-[url(/assets/images/manga/kv-slider-02.png)]"></div>
        <div className="slide-image bg-[url(/assets/images/manga/kv-slider-03.png)]"></div>
      </div>
