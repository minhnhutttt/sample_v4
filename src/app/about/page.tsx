  ...
  return (
    <div className="">
      <div className="relative h-[650px] overflow-hidden bg-white p-2.5 pb-0! md:h-[864px] md:p-5">
        <div className="absolute inset-0 flex flex-col items-center justify-center px-5 pt-32 pb-10 text-center md:pt-[60px] md:pb-[90px]">
          <h1 className="text-[24px] font-extrabold text-white md:text-[40px] xl:text-[85px]">
            <img src="/assets/images/about-title.svg" alt="" />
          </h1>
          <p className="px-5 text-[18px] leading-[1.4] font-extrabold text-white md:text-[35px]">
            3×3のバスケットボールの楽しみ方をお伝えします！
          </p>
        </div>
        <img
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-5 p-5 px-5 max-md:px-0 md:gap-x-12 md:p-8">
        {[
          {
            id: '#section01',
            text: <>3x3バスケットボー ルって？</>,
          ...
          <Link
            href={item.id}
            className="flex h-12 items-center border-l-[4px] border-[#FF0000] pl-3 text-[15px] font-medium duration-200 hover:text-[#FF0000] max-md:w-[150px] md:h-[62px] md:border-l-[8px] md:pl-5 md:text-[18px] xl:text-[20px]"
            key={i}
          >
            {item.text}
          </Link>
      ...
      <div className="px-5 pt-20 pb-32 md:pt-22 md:pb-40">
        <div className="relative mx-auto w-full max-w-160 md:max-w-[1060px]">
          <div>
            <Title title="ABOUT 3×3" sub="3×3バスケットボールの楽しみ方" />
          </div>
          <div>
            <div
              id="section01"
