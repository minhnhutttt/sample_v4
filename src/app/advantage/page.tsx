  ...
  return (
    <div>
          ...
          <div className="mx-auto w-full max-w-[1200px]">
            ...
            <div className="mt-20 ml-auto max-w-[500px] md:mt-50">
              ...
              <p className="mt-5 text-[13px] font-medium md:mt-8 md:text-[16px]">
                当社は愛媛県新居浜市を拠点に、長年にわたって地域の建設工事を支えてきました。管工事、弁設備工事、回転機整備、保温工事から土木工事まで、幅広い現場で培った技術と経験をもとに、地域の企業・施設のあらゆるニーズにお応えしています。工場設備の改修工事から公共施設のメンテナンスまで、地域密着型の総合建設会社として信頼をいただき、高い施工力とスピード感を武器に地域に根ざした仕事をしています。「現場第一」の姿勢で、お客様の課題解決に全力で取り組みます。
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto my-32 w-full max-w-[1280px] space-y-30 overflow-hidden md:my-[260px] md:space-y-59">
        ...
        >
          熟練の職人が在籍し、配管工事において一貫した工程管理を実現できます。
          <br />
          <br />
        ...
        >
          職人の技術向上に力を入れており、管工事、弁設備工事、保温工事、回転機整備など多岐にわたる施工技術を持ち合わせています。
          <br />
          <br />
